...
def get_ip(typ='free'):
    ...
    if typ == 'free':
        ...
        tiquApiUrl = 'http://proxy.siyetian.com/apis_get.html?token=gHbi1iTqlkMNR1aw8EVZdXTn1STqFUeNpXQw0kaRlXTEVVMPR0az0EVjl3TEFle.wM1MDMwIzN4YTM&limit=1&type=0&time=&split=1&split_text=&repeat=0&isp=0'
    elif typ == 'paid':
